...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Camera.group_id'
        db.add_column('vms_camera', 'group_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Camera.group_name'
        db.add_column('vms_camera', 'group_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Camera.group_id'
        db.delete_column('vms_camera', 'group_id')

        # Deleting field 'Camera.group_name'
        db.delete_column('vms_camera', 'group_name')
    ...
    models = {
        ...
        'vms.storage': {
            ...
            'used_for_writing': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'vms.userprofile': {
