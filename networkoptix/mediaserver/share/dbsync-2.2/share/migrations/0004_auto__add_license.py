...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vms_license', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('signature', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('camera_count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('vms', ['License'])


    def backwards(self, orm):
        
        # Deleting model 'License'
        db.delete_table('vms_license')
