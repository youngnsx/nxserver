...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Camera.blocked'
        db.delete_column('vms_camera', 'blocked')

        # Adding field 'Camera.schedule_disabled'
        db.add_column('vms_camera', 'schedule_disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Camera.blocked'
        db.add_column('vms_camera', 'blocked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Camera.schedule_disabled'
        db.delete_column('vms_camera', 'schedule_disabled')
