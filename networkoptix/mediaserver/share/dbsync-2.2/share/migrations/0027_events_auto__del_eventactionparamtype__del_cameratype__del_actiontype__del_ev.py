...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vms_businessrule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event_type', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('event_resource', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_resource', null=True, to=orm['vms.Resource'])),
            ('event_condition', self.gf('django.db.models.fields.CharField')(max_length=16384)),
            ('action_type', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('action_resource', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='action_resource', null=True, to=orm['vms.Resource'])),
            ('action_params', self.gf('django.db.models.fields.CharField')(max_length=16384)),
        ))
        db.send_create_signal('vms', ['BusinessRule'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('vms_businessrule')
    ...
    models = {
        ...
        'vms.businessrule': {
            ...
            'action_resource': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'action_resource'", 'null': 'True', 'to': "orm['vms.Resource']"}),
            ...
            'event_resource': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'event_resource'", 'null': 'True', 'to': "orm['vms.Resource']"}),
