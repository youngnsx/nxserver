...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CameraServerItem'
        db.create_table('vms_cameraserveritem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mac', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('server_guid', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('timestamp', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('vms', ['CameraServerItem'])

    def backwards(self, orm):
        # Deleting model 'CameraServerItem'
        db.delete_table('vms_cameraserveritem')
