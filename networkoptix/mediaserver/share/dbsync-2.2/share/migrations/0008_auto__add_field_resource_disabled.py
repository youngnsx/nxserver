...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Resource.disabled'
        db.add_column('vms_resource', 'disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Resource.disabled'
        db.delete_column('vms_resource', 'disabled')
