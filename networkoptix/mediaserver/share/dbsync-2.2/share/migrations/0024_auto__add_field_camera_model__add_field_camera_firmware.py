...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Camera.model'
        db.add_column('vms_camera', 'model',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Camera.firmware'
        db.add_column('vms_camera', 'firmware',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Camera.model'
        db.delete_column('vms_camera', 'model')

        # Deleting field 'Camera.firmware'
        db.delete_column('vms_camera', 'firmware')
