...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BusinessRule.action_resource'
        db.delete_column('vms_businessrule', 'action_resource_id')

        # Deleting field 'BusinessRule.event_resource'
        db.delete_column('vms_businessrule', 'event_resource_id')

        # Adding M2M table for field event_resources on 'BusinessRule'
        db.create_table('vms_businessrule_event_resources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('businessrule', models.ForeignKey(orm['vms.businessrule'], null=False)),
            ('resource', models.ForeignKey(orm['vms.resource'], null=False))
        ))
        db.create_unique('vms_businessrule_event_resources', ['businessrule_id', 'resource_id'])

        # Adding M2M table for field action_resources on 'BusinessRule'
        db.create_table('vms_businessrule_action_resources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('businessrule', models.ForeignKey(orm['vms.businessrule'], null=False)),
            ('resource', models.ForeignKey(orm['vms.resource'], null=False))
        ))
        db.create_unique('vms_businessrule_action_resources', ['businessrule_id', 'resource_id'])


    def backwards(self, orm):
        # Adding field 'BusinessRule.action_resource'
        db.add_column('vms_businessrule', 'action_resource',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='action_resource', null=True, to=orm['vms.Resource'], blank=True),
                      keep_default=False)

        # Adding field 'BusinessRule.event_resource'
        db.add_column('vms_businessrule', 'event_resource',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_resource', null=True, to=orm['vms.Resource'], blank=True),
                      keep_default=False)

        # Removing M2M table for field event_resources on 'BusinessRule'
        db.delete_table('vms_businessrule_event_resources')

        # Removing M2M table for field action_resources on 'BusinessRule'
        db.delete_table('vms_businessrule_action_resources')
