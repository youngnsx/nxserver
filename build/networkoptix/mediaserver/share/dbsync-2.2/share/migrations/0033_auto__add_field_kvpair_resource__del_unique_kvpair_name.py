...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'KvPair', fields ['name']
        db.delete_unique('vms_kvpair', ['name'])

        # Adding field 'KvPair.resource'
        db.add_column('vms_kvpair', 'resource',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['vms.Resource']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KvPair.resource'
        db.delete_column('vms_kvpair', 'resource_id')

        # Adding unique constraint on 'KvPair', fields ['name']
        db.create_unique('vms_kvpair', ['name'])
