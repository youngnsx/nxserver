...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layout.background_opacity'
        db.alter_column('vms_layout', 'background_opacity', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Layout.background_opacity'
        db.alter_column('vms_layout', 'background_opacity', self.gf('django.db.models.fields.IntegerField')())
