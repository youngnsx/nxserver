...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessRule.disabled'
        db.add_column('vms_businessrule', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessRule.comments'
        db.add_column('vms_businessrule', 'comments',
                      self.gf('django.db.models.fields.CharField')(max_length=16384, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BusinessRule.schedule'
        db.add_column('vms_businessrule', 'schedule',
                      self.gf('django.db.models.fields.CharField')(max_length=16384, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessRule.disabled'
        db.delete_column('vms_businessrule', 'disabled')

        # Deleting field 'BusinessRule.comments'
        db.delete_column('vms_businessrule', 'comments')

        # Deleting field 'BusinessRule.schedule'
        db.delete_column('vms_businessrule', 'schedule')
