...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('vms_camera', 'networkdevice_ptr_id', 'resource_ptr_id')
        db.delete_table('vms_networkdevice')


    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'Camera.networkdevice_ptr'
        raise RuntimeError("Cannot reverse this migration. 'Camera.networkdevice_ptr' and its values cannot be restored.")
