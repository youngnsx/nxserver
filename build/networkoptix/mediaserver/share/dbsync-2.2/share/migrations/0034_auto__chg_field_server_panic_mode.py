...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Server.panic_mode'
        db.alter_column('vms_server', 'panic_mode', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Server.panic_mode'
        db.alter_column('vms_server', 'panic_mode', self.gf('django.db.models.fields.BooleanField')())
