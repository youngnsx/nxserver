...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Camera.dewarping_params'
        db.add_column('vms_camera', 'dewarping_params',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LayoutItem.dewarping_params'
        db.add_column('vms_layoutitem', 'dewarping_params',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Camera.dewarping_params'
        db.delete_column('vms_camera', 'dewarping_params')

        # Deleting field 'LayoutItem.dewarping_params'
        db.delete_column('vms_layoutitem', 'dewarping_params')
    ...
    models = {
        ...
        'vms.camera': {
            ...
            'control_disabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'dewarping_params': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'secondary_quality': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'status_flags': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        ...
        'vms.layout': {
            ...
            'background_image_filename': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'background_opacity': ('django.db.models.fields.FloatField', [], {'default': '0.7'}),
        ...
        'vms.layoutitem': {
            ...
            'contrast_params': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'dewarping_params': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
