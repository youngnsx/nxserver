...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layout.background_image_id'
        db.add_column('vms_layout', 'background_image_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Layout.background_width'
        db.add_column('vms_layout', 'background_width',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Layout.background_height'
        db.add_column('vms_layout', 'background_height',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Layout.locked'
        db.add_column('vms_layout', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layout.background_image_id'
        db.delete_column('vms_layout', 'background_image_id')

        # Deleting field 'Layout.background_width'
        db.delete_column('vms_layout', 'background_width')

        # Deleting field 'Layout.background_height'
        db.delete_column('vms_layout', 'background_height')

        # Deleting field 'Layout.locked'
        db.delete_column('vms_layout', 'locked')
