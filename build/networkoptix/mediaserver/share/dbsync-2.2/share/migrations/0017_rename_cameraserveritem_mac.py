...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('vms_cameraserveritem', 'mac', 'physical_id')
        db.alter_column('vms_cameraserveritem', 'physical_id', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        db.rename_column('vms_cameraserveritem', 'physical_id', 'mac')
        db.alter_column('vms_cameraserveritem', 'mac', self.gf('django.db.models.fields.CharField')(max_length=20))
