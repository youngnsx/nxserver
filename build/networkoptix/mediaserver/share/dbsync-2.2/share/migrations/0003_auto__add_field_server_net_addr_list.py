...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Server.net_addr_list'
        db.add_column('vms_server', 'net_addr_list', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Server.net_addr_list'
        db.delete_column('vms_server', 'net_addr_list')
