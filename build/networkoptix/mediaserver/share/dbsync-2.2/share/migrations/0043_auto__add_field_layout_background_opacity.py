...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layout.background_opacity'
        db.add_column('vms_layout', 'background_opacity',
                      self.gf('django.db.models.fields.IntegerField')(default=70),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layout.background_opacity'
        db.delete_column('vms_layout', 'background_opacity')
