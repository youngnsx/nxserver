...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessRule.aggregation_period'
        db.add_column('vms_businessrule', 'aggregation_period',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BusinessRule.event_state'
        db.add_column('vms_businessrule', 'event_state',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessRule.aggregation_period'
        db.delete_column('vms_businessrule', 'aggregation_period')

        # Deleting field 'BusinessRule.event_state'
        db.delete_column('vms_businessrule', 'event_state')
