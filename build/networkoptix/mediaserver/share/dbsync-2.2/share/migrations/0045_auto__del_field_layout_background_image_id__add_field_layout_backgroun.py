...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layout.background_image_filename'
        db.add_column('vms_layout', 'background_image_filename',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Layout.background_image_filename'
        db.delete_column('vms_layout', 'background_image_filename')
