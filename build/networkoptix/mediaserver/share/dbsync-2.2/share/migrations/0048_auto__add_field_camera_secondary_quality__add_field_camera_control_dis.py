...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Camera.secondary_quality'
        db.add_column('vms_camera', 'secondary_quality',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Camera.control_disabled'
        db.add_column('vms_camera', 'control_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Camera.secondary_quality'
        db.delete_column('vms_camera', 'secondary_quality')

        # Deleting field 'Camera.control_disabled'
        db.delete_column('vms_camera', 'control_disabled')
