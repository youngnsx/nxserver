...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayoutItem.contrast_params'
        db.add_column('vms_layoutitem', 'contrast_params',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayoutItem.contrast_params'
        db.delete_column('vms_layoutitem', 'contrast_params')
