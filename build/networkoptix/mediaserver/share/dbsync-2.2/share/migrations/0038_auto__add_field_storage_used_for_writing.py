...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Storage.used_for_writing'
        db.add_column('vms_storage', 'used_for_writing',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=True)


    def backwards(self, orm):
        # Deleting field 'Storage.used_for_writing'
        db.delete_column('vms_storage', 'used_for_writing')
