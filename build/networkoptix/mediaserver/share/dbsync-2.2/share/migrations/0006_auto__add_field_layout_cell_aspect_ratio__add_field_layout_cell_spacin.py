...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layout.cell_aspect_ratio'
        db.add_column('vms_layout', 'cell_aspect_ratio', self.gf('django.db.models.fields.FloatField')(default=-1), keep_default=False)

        # Adding field 'Layout.cell_spacing_width'
        db.add_column('vms_layout', 'cell_spacing_width', self.gf('django.db.models.fields.FloatField')(default=-1), keep_default=False)

        # Adding field 'Layout.cell_spacing_height'
        db.add_column('vms_layout', 'cell_spacing_height', self.gf('django.db.models.fields.FloatField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Layout.cell_aspect_ratio'
        db.delete_column('vms_layout', 'cell_aspect_ratio')

        # Deleting field 'Layout.cell_spacing_width'
        db.delete_column('vms_layout', 'cell_spacing_width')

        # Deleting field 'Layout.cell_spacing_height'
        db.delete_column('vms_layout', 'cell_spacing_height')
    ...
    models = {
        ...
        'vms.layout': {
            ...
            'cell_aspect_ratio': ('django.db.models.fields.FloatField', [], {}),
            'cell_spacing_height': ('django.db.models.fields.FloatField', [], {}),
            'cell_spacing_width': ('django.db.models.fields.FloatField', [], {}),
