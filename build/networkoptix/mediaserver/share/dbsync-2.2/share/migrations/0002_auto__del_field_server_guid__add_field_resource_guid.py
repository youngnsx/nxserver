...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Server.guid'
        db.delete_column('vms_server', 'guid')

        # Adding field 'Resource.guid'
        db.add_column('vms_resource', 'guid', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Server.guid'
        raise RuntimeError("Cannot reverse this migration. 'Server.guid' and its values cannot be restored.")

        # Deleting field 'Resource.guid'
        db.delete_column('vms_resource', 'guid')
